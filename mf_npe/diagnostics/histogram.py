...
This module provides a function to generate simulations from a trained posterior,
calculate summary statistics from those simulations, and plot their distributions against the observed summary statistics.
"""
