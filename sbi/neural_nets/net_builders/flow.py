...
def build_zuko_nsf_mf(
    ...
    embedding_net: nn.Module = nn.Identity(),
    num_bins: int = 8,
    base_density_estimator: ZukoFlow = None,
    **kwargs,
) -> ZukoFlow:
    """
    Build a Neural Spline Flow (NSF) with monotonic rational-quadratic spline
    ...
    flow = build_zuko_flow_mf(
        ...
        num_transforms,
        embedding_net,
        base_density_estimator,
        **additional_kwargs,
    )
    
    # neural_net = Flow(
    #             transform=[
    #                 base_density_estimator.net.transform.transforms[0],
    #                 base_density_estimator.net.transform.transforms[1],
    #                 base_density_estimator.net.transform.transforms[2],
    #                 base_density_estimator.net.transform.transforms[3],
    #                 #b_model2.transform.transforms[-1],
    #                 #add_layer, # No affine layer needed because we have a z-score layer in neural_net_hf
    #             ],
    #             base=base_density_estimator.net.base, 
    #         )
